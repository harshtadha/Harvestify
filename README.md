# HARVESTIFY 🌿
#### A simple Data Sicence,ML and DL based website which recommends the best crop to grow, fertilizers to use and the diseases caught by your crops.
...
- [Fertilizer suggestion dataset](https://github.com/harshtadha/Harvestify/blob/main/Data-processed/crop_recommendation.csv) (custom built dataset)
